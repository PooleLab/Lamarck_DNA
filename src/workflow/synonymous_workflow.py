...
# To test Lamarckian inheritance - inserting synonymous mutations at codon level in each iteration
...
def clear_output_directory():
    remove_directory_contents("../synonymous/output/")
    print("Cleared contents of ../synonymous/output/ directory")


class SynonymousWorkflow:
    ...
    def start(self):
        print("Starting synonymous section mutation workflow")
        ...
        converter = MidiToDNAConverterV2('../synonymous/' + self.input_file,
                                         "../synonymous/output/dna_original.txt",
                                         self.tempo)
        converter.convert()
        ...
        for i in range(self.iterations):
            ...
            converter = DNAToMutatedDNAConverter("../synonymous/output/" + inter_input,
                                                 "../synonymous/output/dna_" + idx + ".txt",
